...
//! Lidar param:
double lidar_detect_front = 0.75;
double lidar_detect_width =0.5;
...
void laserCallback(const sensor_msgs::LaserScan& laser_scan) {
        ...
        isCorridorBlocked(laser_scan, lidar_detect_width, lidar_detect_front);
