...
private:
    ...
    actionlib::SimpleActionServer<Lab9::trajAction> as_;

    // here are some message types to communicate with our client(s)
    Lab9::trajGoal goal_; // goal message, received from client
    Lab9::trajResult result_; // put results here, to be sent back to the client when done w/ goal
    Lab9::trajFeedback feedback_; // not used in this example; 
...
public:
    ...
    // Action Interface
    void executeCB(const actionlib::SimpleActionServer<Lab9::trajAction>::GoalConstPtr& goal);
};
...
void trajActionServer::executeCB(const actionlib::SimpleActionServer<Lab9::trajAction>::GoalConstPtr& goal) {
